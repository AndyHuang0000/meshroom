        ...
        delegate: MediaLoader {
            ...
            onFinalSourceChanged: {
                ...
                if(object) {
                    ...
                    model.vertexCount = Qt.binding(function() { return object ? object.vertexCount : 0; });
                    model.faceCount = Qt.binding(function() { return object ? object.faceCount : 0; });
                    model.cameraCount = Qt.binding(function() { return object ? object.cameraCount : 0; });
                    model.textureCount = Qt.binding(function() { return object ? object.textureCount : 0; });
                }
            }
